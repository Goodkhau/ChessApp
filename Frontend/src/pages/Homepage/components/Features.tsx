		...
		<section className="max-w-7xl mx-auto h-0 hidden lg:block lg:h-[10000px] py-32 px-6" ref={ref}>
			...
			<motion.div className={`sticky z-10 top-0 h-screen flex flex-col items-center justify-center gap-4
				...
				<div className="flex justify-between gap-4">
					<div className="flex flex-col justify-center p-4 bg-linear-to-br from-slate-950/80 via-slate-950/95 to-slate-950/80 rounded-4xl w-45">
						<h2 className="text-xl text-center text-slate-300">Neural Network Design</h2>
					</div>
